...
class MessageBubble extends StatelessWidget {
  const MessageBubble({
    ...
    required this.isSeenByPartner,
  });

  final MessageModel message;
  final bool isMine;
  final bool isSeenByPartner;
            ...
            Row(
              ...
              children: [
                ...
                if (isMine) ...[
                  ...
                  Icon(isSeenByPartner ? Icons.done_all : Icons.done, size: 16,
                      color: isSeenByPartner ? Colors.lightBlueAccent : Colors.white70),
                ],
              ],
            ),
          ],
