...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
        titleSpacing: 0,
        title: StreamBuilder<UserProfileModel?>(
  stream: _userService.userStream(widget.partnerId),
  ...
  isDeliveredToPartner: message.isDeliveredTo(widget.partnerId),
);
                  },
                );
              },
  ...
  _chatService
      .markReceivedMessagesDelivered(
        currentUserId: currentUserId,
        partnerId: partnerId,
        messages: messages,
      )
      .then((_) {
        return _chatService.markReceivedMessagesSeen(
          currentUserId: currentUserId,
          partnerId: partnerId,
          messages: messages,
        );
